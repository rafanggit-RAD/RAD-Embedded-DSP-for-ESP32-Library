...
// (dsp_schema.h removed, schema is dynamically generated by ESP32)
...
void setup() {
    ...
    // ====================================================================
    // I2S Input EQ (ID 1-8)
    dspControl.attach(1, &EqI2S_0_L, "EqI2S_0_L");
    dspControl.attach(2, &EqI2S_0_R, "EqI2S_0_R");
    dspControl.attach(3, &EqI2S_1_L, "EqI2S_1_L");
    dspControl.attach(4, &EqI2S_1_R, "EqI2S_1_R");
    dspControl.attach(5, &EqI2S_2_L, "EqI2S_2_L");
    dspControl.attach(6, &EqI2S_2_R, "EqI2S_2_R");
    dspControl.attach(7, &EqI2S_3_L, "EqI2S_3_L");
    dspControl.attach(8, &EqI2S_3_R, "EqI2S_3_R");
    // I2S Compressor (ID 9-10)
    dspControl.attach(9, &CompI2S_L, "CompI2S_L");
    dspControl.attach(10, &CompI2S_R, "CompI2S_R");
    // BT Input EQ (ID 11-18)
    dspControl.attach(11, &EqBT_0_L, "EqBT_0_L");
    dspControl.attach(12, &EqBT_0_R, "EqBT_0_R");
    dspControl.attach(13, &EqBT_1_L, "EqBT_1_L");
    dspControl.attach(14, &EqBT_1_R, "EqBT_1_R");
    dspControl.attach(15, &EqBT_2_L, "EqBT_2_L");
    dspControl.attach(16, &EqBT_2_R, "EqBT_2_R");
    dspControl.attach(17, &EqBT_3_L, "EqBT_3_L");
    dspControl.attach(18, &EqBT_3_R, "EqBT_3_R");
    // Mixers (ID 19-20)
    dspControl.attach(19, &mixerL, "mixerL"); 
    dspControl.attach(20, &mixerR, "mixerR"); 
    // Master EQ (ID 21-32)
    dspControl.attach(21, &EqMaster_0_L, "EqMaster_0_L");
    dspControl.attach(22, &EqMaster_0_R, "EqMaster_0_R");
    dspControl.attach(23, &EqMaster_1_L, "EqMaster_1_L");
    dspControl.attach(24, &EqMaster_1_R, "EqMaster_1_R");
    dspControl.attach(25, &EqMaster_2_L, "EqMaster_2_L");
    dspControl.attach(26, &EqMaster_2_R, "EqMaster_2_R");
    dspControl.attach(27, &EqMaster_3_L, "EqMaster_3_L");
    dspControl.attach(28, &EqMaster_3_R, "EqMaster_3_R");
    dspControl.attach(29, &EqMaster_4_L, "EqMaster_4_L");
    dspControl.attach(30, &EqMaster_4_R, "EqMaster_4_R");
    dspControl.attach(31, &EqMaster_5_L, "EqMaster_5_L");
    dspControl.attach(32, &EqMaster_5_R, "EqMaster_5_R");
    // FIR Filters (ID 33-34)
    dspControl.attach(33, &firL, "firL");
    dspControl.attach(34, &firR, "firR");
    // Master Limiters (ID 35-36)
    dspControl.attach(35, &LimiterMaster_L, "LimiterMaster_L");
    dspControl.attach(36, &LimiterMaster_R, "LimiterMaster_R");
    // VU Meters (ID 39-44)
    dspControl.attach(39, &meterL, "meterL");
    dspControl.attach(40, &meterR, "meterR");
    dspControl.attach(41, &meterAnalogL, "meterAnalogL");
    dspControl.attach(42, &meterAnalogR, "meterAnalogR");
    dspControl.attach(43, &meterBtL, "meterBtL");
    dspControl.attach(44, &meterBtR, "meterBtR");
    // Output Routers (ID 37-38)
    dspControl.attach(37, &routerL, "routerL");
    dspControl.attach(38, &routerR, "routerR");
